...
module FCManifest
  def associateDAMReferences
    @logo = "#{BRANDS_EXT}/FC/images/FirstCommercialBeta.png"
    # these two are from carousel
    @newBusiness = "new quote"
    @quoteSearch = "quote search"
    
    # single line row widget images
    @mandatoryIcon = "#{BRANDS_EXT}/FC/images/star.png"
    @tickIcon = "#{BRANDS_EXT}/FC/images/tick.png"
    @helpIcon = "#{BRANDS_EXT}/FC/images/information.png"

    #teaser images
    @van_teaser = "#{BRANDS_EXT}/FC/images/van_teaser.jpg"
    @pub_teaser = "#{BRANDS_EXT}/FC/images/pub_teaser.jpg"
    @hotel_teaser = "#{BRANDS_EXT}/FC/images/hotel_teaser.jpg"
    @surgery_teaser = "#{BRANDS_EXT}/FC/images/surgery_teaser.jpg"
    
    #images
    @florist_ad = "#{BRANDS_EXT}/FC/images/FloristAdvert.jpg"
