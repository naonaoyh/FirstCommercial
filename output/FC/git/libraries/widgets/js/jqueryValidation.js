...
$.extend($.validator, {
	...
	prototype: {
		...
		/*
		either hijack the showLabel functionality
		or write a custom embellish function
		basically, if things are valid, show validity
		*/
		...
		showLabel: function(element, message) {
			...
			if ( label.length ) {
				...
				var coordinates = jQuery(element).offset()
				...
				if ( !this.labelContainer.append(label).length )
					this.settings.errorPlacement
						...
						//jQuery(label).css("left",x+150).css("top",y+30);
	...
	/*
	Class rules being used to specify validation methods
	*/
